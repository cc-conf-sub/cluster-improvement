...
public class Helper {
    ...
    public static int quick_edit_dist(ArrayList<ArrayList<Integer>> clustering, ArrayList<ArrayList<Integer>> prob_matrix) {
        /*
           Quick edit distance for large 0/1 graphs
        */

        int dist = 0;
        HashMap<Integer, Integer> cluster_map = Helper.get_clustering_map(clustering);
        ...
        for (int i = 0; i < prob_matrix.size(); i++) {
            ...
            int x1 = 0; // neighbors of i with same cluster label
            int x2 = 0; // neighbors of i with different cluster label
            ...
            int update = x2 + cluster_sizes[cur_label] - x1 - 1;
    ...
    public static double[] get_precision_recall(ArrayList<ArrayList<Integer>> clustering, ArrayList<ArrayList<Integer>> prob_matrix) {
        ...
        */
        ...
        int cost_inside = clustered_pairs - dist;
        int cost_outside = total_pos - dist;
        int total_cost = cost_inside + cost_outside;
        int all_pairs = prob_matrix.size() * (prob_matrix.size() - 1) / 2;
        double estimate = (1 - precision) / (2 - precision);

        double out_est = (1 - precision) * clustered_pairs;

	//System.out.println("Precision: " + precision);
        //System.out.println("Clustered Pairs: " + clustered_pairs);
        //System.out.println("Inside Pos: " + dist);
	//System.out.println("Outside Pos: "+ cost_outside);
	//System.out.println("Outside Estimate: " + out_est);
        //System.out.println("Total Pos: " + total_pos);
        System.out.println("Inside: " + (cost_inside / (double) total_cost));
        //System.out.println("Lower Bound: " + estimate);
